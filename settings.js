...
export function settingsInit(){
    game.settings.register(MODULEID, "sendWeatherReport",{
        name: "Weather Report",
      ...
      game.settings.register(MODULEID, "posTemp",{
      ...
      game.settings.register(MODULEID, "posWind",{
        name: "Wind Position",
      ...
      game.settings.register(MODULEID, "posSnow",{
